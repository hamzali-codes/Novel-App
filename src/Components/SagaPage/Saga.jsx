...
function NavigationBar(){
   return( 
    ...
    <div className='gap-[16px] h-[10%] flex w-full lg:h-[13%] items-center lg:gap-[90px] bg-black text-white'>
          ...
          <p className = 'text-[15px] lg:text-[18px] active:border-b-4 border-[#D4AF37] cursor-pointer flex items-center h-full hover:text-[#D4AF37] transition-colors duration-200' style={{fontFamily: '"Inria Sans", sans-serif'}}>About</p>
       </div>
...
function Title(){
    return(
      <div className=' w-full mt-[10px] flex flex-col justify-center text-center items-center '>
        <p className='text-[28px] text-[#D4AF37] lg:text-[50px] font-medium' style={{fontFamily: '"Changa", sans-serif', 
        textShadow: `
      -2px -2px 0 #000,
       2px -2px 0 #000,
      -2px 2px 0 #000,
       2px 2px 0 #000
    `}}>The Sword Village</p>
        <p className='text-[22px] text-white lg:text-[28px] font-bold' style={{fontFamily: '"Inria Sans", sans-serif'}}>CHAPTERS</p>
      </div>
    );
...
function Chapters(){
    return(
        <div className='gird grid-col-2 lg:flex w-full mt-[10px] justify-evenly'>
          <div className='flex flex-col justify-center items-center gap-2 lg:mt-0 mt-[22px]'>
        ...
        <div className='flex flex-col justify-center items-center gap-2 lg:mt-0 mt-[28px]'>
            <p className='text-white text-[24px] sm:mt-[6px]' style={{fontFamily: '"Inria Sans", sans-serif'}}>CHAPTER 2</p>
